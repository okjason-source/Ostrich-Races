...
const OSTRICH_COLORS = [
    { name: 'Golden Emperor', color: '#FFD700', saddle: '#FFD700', collar: '#FF00FF' },
    { name: 'Diamond Dynasty', color: '#FF00FF', saddle: '#FF00FF', collar: '#00FFFF' },
    { name: 'Platinum Thunder', color: '#00FFFF', saddle: '#00FFFF', collar: '#FF00FF' },
    { name: 'Royal Fortune', color: '#8A2BE2', saddle: '#8A2BE2', collar: '#FFD700' },
    { name: 'Emerald Tycoon', color: '#00FF00', saddle: '#00FF00', collar: '#FF00FF' },
    { name: 'Ruby Luxe', color: '#FF1493', saddle: '#FF1493', collar: '#00FFFF' },
    { name: 'Sapphire Elite', color: '#00CED1', saddle: '#00CED1', collar: '#FFD700' },
    { name: 'Amber Sovereign', color: '#FFA500', saddle: '#FFA500', collar: '#FF00FF' }
];
